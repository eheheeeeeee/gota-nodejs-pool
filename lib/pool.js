...
function processShare (miner, job, blockTemplate, params) {
	...
	if (hashDiff.ge(blockTemplate.difficulty)) {
		...
		apiInterfaces.rpcDaemon('submit', {blocktemplate_blob: shareBuffer.toString('hex')}, function(error, result){
			if (error) {
	...
	if (childBlockTemplate) {
		if (mergedMining) {
          ...
          apiInterfaces.rpcDaemon('submit', {blocktemplate_blob: mergedBuffer.toString('hex')}, function(error, result){
						if (error) {
